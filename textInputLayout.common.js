...
var tintColorProperty = new dependency_observable_1.Property("tintColor", TIL, new proxy_1.PropertyMetadata(true, dependency_observable_1.PropertyMetadataSettings.AffectsStyle));
var lineColorProperty = new dependency_observable_1.Property("lineColor", TIL, new proxy_1.PropertyMetadata(true, dependency_observable_1.PropertyMetadataSettings.AffectsStyle));
var selectedTitleColorProperty = new dependency_observable_1.Property("selectedTitleColor", TIL, new proxy_1.PropertyMetadata(true, dependency_observable_1.PropertyMetadataSettings.AffectsStyle));
var selectedLineColorProperty = new dependency_observable_1.Property("selectedLineColor", TIL, new proxy_1.PropertyMetadata(true, dependency_observable_1.PropertyMetadataSettings.AffectsStyle));
var lineHeightProperty = new dependency_observable_1.Property("lineHeight", TIL, new proxy_1.PropertyMetadata(true, dependency_observable_1.PropertyMetadataSettings.AffectsLayout));
var selectedLineHeightProperty = new dependency_observable_1.Property("selectedLineHeight", TIL, new proxy_1.PropertyMetadata(true, dependency_observable_1.PropertyMetadataSettings.AffectsLayout));
var errorColorProperty = new dependency_observable_1.Property("errorColor", TIL, new proxy_1.PropertyMetadata(true, dependency_observable_1.PropertyMetadataSettings.AffectsStyle));
var iconColorProperty = new dependency_observable_1.Property("iconColor", TIL, new proxy_1.PropertyMetadata(true, dependency_observable_1.PropertyMetadataSettings.AffectsStyle));
var selectedIconColorProperty = new dependency_observable_1.Property("selectedIconColor", TIL, new proxy_1.PropertyMetadata(true, dependency_observable_1.PropertyMetadataSettings.AffectsStyle));
var iconFontProperty = new dependency_observable_1.Property("iconFont", TIL, new proxy_1.PropertyMetadata(true, dependency_observable_1.PropertyMetadataSettings.AffectsStyle));
var iconTextProperty = new dependency_observable_1.Property("iconText", TIL, new proxy_1.PropertyMetadata(true, dependency_observable_1.PropertyMetadataSettings.AffectsStyle));
var iconMarginBottomProperty = new dependency_observable_1.Property("iconMarginBottom", TIL, new proxy_1.PropertyMetadata(true, dependency_observable_1.PropertyMetadataSettings.AffectsLayout));
var iconMarginLeftProperty = new dependency_observable_1.Property("iconMarginLeft", TIL, new proxy_1.PropertyMetadata(true, dependency_observable_1.PropertyMetadataSettings.AffectsLayout));
var iconRotationDegreesProperty = new dependency_observable_1.Property("iconRotationDegrees", TIL, new proxy_1.PropertyMetadata(true, dependency_observable_1.PropertyMetadataSettings.AffectsLayout));
